...
(cl:defmethod cl:initialize-instance :after ((m <hello>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'hello)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test1-msg:<hello> is deprecated: use test1-msg:hello instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <hello>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test1-msg:num-val is deprecated.  Use test1-msg:num instead.")
  (num m))
