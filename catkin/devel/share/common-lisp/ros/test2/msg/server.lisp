...
(cl:defmethod cl:initialize-instance :after ((m <server>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'server)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test2-msg:<server> is deprecated: use test2-msg:server instead.")))

(cl:ensure-generic-function 'IsStart-val :lambda-list '(m))
(cl:defmethod IsStart-val ((m <server>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-msg:IsStart-val is deprecated.  Use test2-msg:IsStart instead.")
  (IsStart m))
