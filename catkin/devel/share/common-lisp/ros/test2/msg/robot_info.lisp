...
(cl:defmethod cl:initialize-instance :after ((m <robot_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test2-msg:<robot_info> is deprecated: use test2-msg:robot_info instead.")))

(cl:ensure-generic-function 'Control_State-val :lambda-list '(m))
(cl:defmethod Control_State-val ((m <robot_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-msg:Control_State-val is deprecated.  Use test2-msg:Control_State instead.")
  (Control_State m))

(cl:ensure-generic-function 'Robot_State-val :lambda-list '(m))
(cl:defmethod Robot_State-val ((m <robot_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-msg:Robot_State-val is deprecated.  Use test2-msg:Robot_State instead.")
  (Robot_State m))

(cl:ensure-generic-function 'Robot_Position-val :lambda-list '(m))
(cl:defmethod Robot_Position-val ((m <robot_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-msg:Robot_Position-val is deprecated.  Use test2-msg:Robot_Position instead.")
  (Robot_Position m))

(cl:ensure-generic-function 'Task_Type-val :lambda-list '(m))
(cl:defmethod Task_Type-val ((m <robot_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-msg:Task_Type-val is deprecated.  Use test2-msg:Task_Type instead.")
  (Task_Type m))

(cl:ensure-generic-function 'Route_Serial-val :lambda-list '(m))
(cl:defmethod Route_Serial-val ((m <robot_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test2-msg:Route_Serial-val is deprecated.  Use test2-msg:Route_Serial instead.")
  (Route_Serial m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robot_info>)))
  ...
  "ec4a3f57734c2b806790604232e483b2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robot_info)))
  "Returns md5sum for a message object of type 'robot_info"
  "ec4a3f57734c2b806790604232e483b2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_info>)))
  ...
  (cl:format cl:nil "uint16 Control_State~%uint16 Robot_State~%uint16 Robot_Position~%uint16 Task_Type~%uint16 Route_Serial~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_info)))
  "Returns full string definition for message of type 'robot_info"
  (cl:format cl:nil "uint16 Control_State~%uint16 Robot_State~%uint16 Robot_Position~%uint16 Task_Type~%uint16 Route_Serial~%~%~%"))
