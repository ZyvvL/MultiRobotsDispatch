...
if("TRUE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/zyvv/work/Rosprj/catkin/src/test2)
  set(test2_DEVEL_PREFIX /home/zyvv/work/Rosprj/catkin/devel)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /home/zyvv/work/Rosprj/catkin/install)
...
if(NOT "/home/zyvv/work/Rosprj/catkin/devel/include " STREQUAL " ")
  set(test2_INCLUDE_DIRS "")
  set(_include_dirs "/home/zyvv/work/Rosprj/catkin/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'zyvv <zyvv@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zyvv/work/Rosprj/catkin/src/test2/${idir}'.  Ask the maintainer 'zyvv <zyvv@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zyvv/work/Rosprj/catkin/devel/lib;/home/zyvv/work/Rosprj/catkin/devel/lib;/opt/ros/kinetic/lib)
